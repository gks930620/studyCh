...
public class ProductList {
	...
	public static void main(String[] args) {
		String str = "정보: INSERT INTO member (                         	    mem_id,     mem_pass,   mem_name,       	    mem_bir,    mem_zip,   mem_add1,        	    mem_add2,   mem_hp,    mem_mail,        	    mem_job,    mem_like,  mem_mileage,     	    mem_del_yn                              	  ) VALUES (                                	   'nolja', 	   '1004', 	   '야놀자', 	   '2007-07-25', 	   '12345', 	   '일본', 	   '간사이', 	   '010-123-4567', 	   'milkis@daum.net', 	   'JB03', 	   'HB07', 	   0,     	   'N' )  ";
		System.out.println(str.replaceAll("(\\w{40})", "a"));
