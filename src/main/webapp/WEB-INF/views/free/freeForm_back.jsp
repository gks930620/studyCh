...
<div class="container">
	...
	<table class="table table-striped table-bordered">
		...
		<tr>
			<th>제목</th>
			<td><input type="text" name="boTitle" value="${free.boTitle}" class="form-control input-sm"  >
		...
		<tr>
			<th>내용</th>
			<td><textarea rows="10" name="boContent" class="form-control">${free.boContent}</textarea>
			</td>
		</tr>
		<tr>
			<td colspan="2">
