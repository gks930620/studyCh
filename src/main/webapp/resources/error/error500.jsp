...
<head>
	<meta charset="utf-8">
		<title>Dragon 요청하신 작업에 문제가 발생했습니다.</title>
...
<div id="kakaoWrap" class="page_error">
	<div id="kakaoHead" role="banner" class="head_error">
		<h1>
			<a href="http://www.daum.net/" class="link_daum"><span class="ir_wa">Dragon</span></a>
		</h1>
	</div>
	<hr class="hide">
	<div id="kakaoContent" class="cont_error" role="main">
				<h2 class="tit_error">요청하신 작업을 진행중
						<span class="emph_txt">문제가 발생하였습니다.</span></h2>
		<p class="desc_error">
			지속적인 오류가 발생시 <br>
			반장엄망게 문의해 주세요 ~~~~
		</p>
		<p class="desc_error">
			<!-- exception 객체는  isErrorPage="true" 인경우 사용가능  -->
			예외이름 <%=exception.getClass().getName() %> <br>
		...
		<div class="info_link">
			<a href="http://www.daum.net/" class="link_error">드래곤첫화면</a>
			<a href="http://cs.daum.net/" class="link_error ">고객센터</a>
		</div>
	</div>
	<hr class="hide">
	<div id="kakaoFoot" class="foot_error" role="contentinfo">
		<small class="info_copyright">Copyright &copy; <a href="http://www.kakaocorp.com/" target="_blank" class="link_kakao">Dragon Corp.</a> All rights reserved.</small>
	</div>
</div>
